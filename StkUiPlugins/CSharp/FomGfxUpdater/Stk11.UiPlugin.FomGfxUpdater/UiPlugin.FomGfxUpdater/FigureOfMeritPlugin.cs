...
namespace UiPlugin.FomGfxUpdater
{

    [Guid("292839ae-b987-4fdb-af0c-2a7b44d3d6ff")]
    [ProgId("Stk11.UiPlugin.FomGfxUpdater")]
    [ClassInterface(ClassInterfaceType.None)]
    public class FigureOfMeritPlugin : IAgUiPlugin, IAgUiPlugin2, IAgUiPluginCommandTarget
    {
        ...
        private const string m_commandText = "Stk11.UiPlugin.FomGfxUpdater";
