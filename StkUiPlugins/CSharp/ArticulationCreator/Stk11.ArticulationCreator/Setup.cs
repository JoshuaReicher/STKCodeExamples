...
namespace Stk11.UiPlugin.Articulations
{

    [Guid("87a8e802-d196-428e-b27b-8e16e0f49f07")]
    [ProgId("Stk11.UiPlugin.Articulations")]
    ...
    public class Setup : IAgUiPlugin, IAgUiPlugin2, IAgUiPlugin3DNotify, IAgUiPluginCommandTarget
    {
        ...
        private const string m_commandText = "Stk11.UiPlugin.Articulations";
        private const string m_pluginTitle = "Articulation Creator";
        private const string m_pluginDescription = "Articulation Creator";
        private const string m_pluginConfigPage = "Stk11.UiPlugin.Articulations Config Page";
        private const string m_imageResource = "Stk11.UiPlugin.Articulations.Images.STK.ico";
        private const string m_configPath = "Stk11.UiPlugin.Articulations_config.txt";
